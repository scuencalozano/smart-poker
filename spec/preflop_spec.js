...
describe("Posting the small blind", function() {
	...
	it("should make the next player active autoblinds enable", function() {
		table.autoBlinds = true;
	...
	it("should make the next player active autoblinds disable", function() {
	...
	it("should proceed to the big blind phase autoblinds enable", function() {
		table.autoBlinds = true;
		table.playerPostedSmallBlind();
    	expect( table.public.phase ).toEqual( 'preflop' );
	});

	it("should proceed to the big blind phase autoblinds disable", function() {
		table.autoBlinds = false;
		table.playerPostedSmallBlind();
